package com.springboot.rest.restfulwebservices.exception;
...
import com.springboot.rest.restfulwebservices.user.UserNotFoundException;

@ControllerAdvice // all controller will pick this up
